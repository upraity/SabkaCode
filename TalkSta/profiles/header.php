...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">Quizzy Loop</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form style="display:flex;">
              <p class="text-light my-1 ml-1"><a style="text-decoration: none; color:white;" href="http://localhost/comment/profile">Welcome '. $_SESSION['user_name'].'</a></p>
